...
class ArticleCrawler(object):
        ...
        for year in range(start_year, end_year + 1):
            ...
            for month in range(target_start_month, target_end_month + 1):
                for month_day in range(1, calendar.monthrange(year, month)[1] + 1):
                    ...
                    print(url+"&page=10000")
                    # asdf
                    totalpage = ArticleParser.find_news_totalpage(url + "&page=10000")
                    ##########################
                    # 나는 여기를 바로 만으로 때리면 안됨
                    # totalpage 기본은 url + 3991임
                    # 근데 만약 리턴이 0 뜬다?
    ...
    def crawling(self, category_name):
        ...
        # 기사 url 형식
        url_format = f'http://news.naver.com/main/list.nhn?mode=LSD&mid=sec&sid1=' \
            f'{self.categories.get(category_name)}&date='
...
if __name__ == "__main__":
    ...
    Crawler.set_date_range(2020, 9, 2021, 9)
    Crawler.start()